...
public class Pantalla_principal_auxiliar_academico extends javax.swing.JFrame {
    
    private String dni;
    private String nombreCompleto;
    private String correoElectronico;
    
    public Pantalla_principal_auxiliar_academico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton5.setText("Docentes y Estudiantes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pantalla_principal_auxiliar_academico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pantalla_principal_auxiliar_academico().setVisible(true);
            }
        });
    }
