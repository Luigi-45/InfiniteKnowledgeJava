 ...
 * @author Cuack
 */
public class Buscar_docente_curso extends javax.swing.JFrame {
    ...
    public Buscar_docente_curso() {
        initComponents();
        this.modelo = new DefaultTableModel(); this.jtblCursos.setModel(modelo);
    ...
    private void initComponents() {
        ...
        jLabel9.setText("BUSCAR DOCENTE - CURSO:");
        ...
        jButton2.setText("Asignar a estudiante");
    ...
    private void jtblCursosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtblCursosMouseClicked
        try{
            ...
            ventana.setCurso(new CursoBO().buscarPorNombreExacto((String) this.modelo.getValueAt(this.jtblCursos.getSelectedRow(), 0)));
            ventana.setVisible(true);
            this.dispose();
        }
        catch(Exception e){
    ...
    private void rellenarTabla(){
        try{
            ArrayList<Curso> cursos = new CursoBO().listarCursosParaDocente(this.getDocente().getDni());
            for(Curso i:cursos){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Buscar_docente_curso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Buscar_docente_curso().setVisible(true);
            }
        });
    }
